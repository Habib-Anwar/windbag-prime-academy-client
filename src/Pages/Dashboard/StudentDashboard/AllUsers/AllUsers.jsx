...
const AllUsers = () => {
    ...
    const handleMakeAdmin = user =>{
        fetch(`https://windbag-prime-academy-server-tauft-aolcom.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data => {
    ...
    const handleMakeInstructor = user =>{
        fetch(`https://windbag-prime-academy-server-tauft-aolcom.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data => {
